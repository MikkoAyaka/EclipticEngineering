...
private val chestItemRandomTable: Set<Pair<Double,ItemStack>> = setOf(
    ...
    0.5 to ItemStack(Material.LEATHER_HELMET, 1),
    0.5 to ItemStack(Material.LEATHER_CHESTPLATE, 1),
    0.5 to ItemStack(Material.LEATHER_LEGGINGS, 1),
    0.5 to ItemStack(Material.LEATHER_BOOTS, 1),
    0.35 to ItemStack(Material.CHAINMAIL_HELMET, 1),
    0.35 to ItemStack(Material.CHAINMAIL_CHESTPLATE, 1),
    0.35 to ItemStack(Material.CHAINMAIL_LEGGINGS, 1),
    0.35 to ItemStack(Material.CHAINMAIL_BOOTS, 1),
    0.25 to ItemStack(Material.IRON_HELMET, 1),
    0.25 to ItemStack(Material.IRON_CHESTPLATE, 1),
    0.25 to ItemStack(Material.IRON_LEGGINGS, 1),
    0.25 to ItemStack(Material.IRON_BOOTS, 1),
