...
private val chestItemRandomTable: Set<Pair<Double,ItemStack>> = setOf(
    ...
    0.20 to ItemStack(Material.IRON_HELMET, 1),
    0.20 to ItemStack(Material.IRON_CHESTPLATE, 1),
    0.20 to ItemStack(Material.IRON_LEGGINGS, 1),
    0.20 to ItemStack(Material.IRON_BOOTS, 1),
    0.02 to ItemStack(Material.DIAMOND_HELMET, 1),
    0.02 to ItemStack(Material.DIAMOND_CHESTPLATE, 1),
    0.02 to ItemStack(Material.DIAMOND_LEGGINGS, 1),
    0.02 to ItemStack(Material.DIAMOND_BOOTS, 1),
    ...
    0.2 to ItemStack(Material.WOODEN_PICKAXE, 1),
    ...
    0.2 to ItemStack(Material.WOODEN_AXE, 1),
    ...
    0.2 to ItemStack(Material.WOODEN_SHOVEL, 1),
